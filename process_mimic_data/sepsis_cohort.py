...
abx           = pd.read_csv(f"{exportdir}/abx.csv")
culture       = pd.read_csv(f"{exportdir}/culture.csv")
microbio      = pd.read_csv(f"{exportdir}/microbio.csv")
demog         = pd.read_csv(f"{exportdir}/demog.csv")
ce010         = pd.read_csv(f"{exportdir}/ce010000.csv")
ce1020        = pd.read_csv(f"{exportdir}/ce1000020000.csv")
ce2030        = pd.read_csv(f"{exportdir}/ce2000030000.csv")
ce3040        = pd.read_csv(f"{exportdir}/ce3000040000.csv")
ce4050        = pd.read_csv(f"{exportdir}/ce4000050000.csv")
ce5060        = pd.read_csv(f"{exportdir}/ce5000060000.csv")
ce6070        = pd.read_csv(f"{exportdir}/ce6000070000.csv")
ce7080        = pd.read_csv(f"{exportdir}/ce7000080000.csv")
ce8090        = pd.read_csv(f"{exportdir}/ce8000090000.csv")
ce90100       = pd.read_csv(f"{exportdir}/ce90000100000.csv")
MV            = pd.read_csv(f"{exportdir}/mechvent.csv")
inputpreadm   = pd.read_csv(f"{exportdir}/preadm_fluid.csv")
inputMV       = pd.read_csv(f"{exportdir}/fluid_mv.csv")
inputCV       = pd.read_csv(f"{exportdir}/fluid_cv.csv")
vasoMV        = pd.read_csv(f"{exportdir}/vaso_mv.csv")
vasoCV        = pd.read_csv(f"{exportdir}/vaso_cv.csv")
UOpreadm      = pd.read_csv(f"{exportdir}/preadm_uo.csv")
UO            = pd.read_csv(f"{exportdir}/uo.csv")
labU          = [pd.read_csv(f"{exportdir}/labs_ce.csv") , pd.read_csv(f"{exportdir}/labs_le.csv")]

print("Finished loading all csv files")
...
print("Got list of all icustayids")
...
print("Readmissions are determined")
########################################################################
...
sepsis.to_csv(f"{exportdir}/new_sepsis_mimiciii.csv", index=False) 
...
# if pargs.save_intermediate:
MIMICtable.to_csv(f"{exportdir}/MIMICtable.csv", index=False)
...
df.to_csv(f"{exportdir}/sepsis_final_data_withTimes.csv", index=False)
...
for i in data['traj'].keys():
    ...
    for ctr in range(data['traj'][i]['actions'].shape[0]):
        ...
        all_data[-1].append(data['traj'][i]['rewards'][ctr])
df = pd.DataFrame(all_data, columns=col_names)
df.to_csv(f"{exportdir}/sepsis_final_data_RAW_withTimes.csv", index=False)
